      ...
      return {
        ...
        function ($rootScope, $location, $route, $injector) {
          ...
          return {
             ...
             * @return {Promise} the promise your user service returns on 'confirmRegistration'
             */
            confirmRegistration: function (data) {
              return userService.confirmRegistration(data)
                .then(function(user){
                  currentUser = user;
                  $rootScope.$broadcast('$auth:registrationConfirmationSuccess');
                }, function(){
                  $rootScope.$broadcast('$auth:registrationConfirmationFailure');
                });
            },
            ...
            requestPasswordReset: function (email) {
              return userService.requestPasswordReset(email)
                .then(function(){
                  $rootScope.$broadcast('$auth:requestPasswordResetSuccess');
                }, function(error){
                  $rootScope.$broadcast('$auth:requestPasswordResetFailure', error);
                });
            },
            ...
            submitPasswordReset: function (data) {
              return userService.submitPasswordReset(data)
                .then(function(){
                  $rootScope.$broadcast('$auth:submitPasswordResetSuccess');
                }, function(error){
                  $rootScope.$broadcast('$auth:submitPasswordResetFailure', error);
                });
            }
